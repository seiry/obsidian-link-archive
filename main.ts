...
import { saveWebpage } from "src/archive.today";
...
export default class AnotherLinkArchivePlugin extends Plugin {
...
class SampleSettingTab extends PluginSettingTab {
  plugin: AnotherLinkArchivePlugin;

  constructor(app: App, plugin: AnotherLinkArchivePlugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
